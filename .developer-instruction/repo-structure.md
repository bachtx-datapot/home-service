...
*   `.devcontainer/`: Cấu hình Dev Container cho môi trường root (full-stack).
...
*   `.devcontainer/`: Cấu hình Dev Container cho môi trường backend (Python + DB).
...
*   `.devcontainer/`: Cấu hình Dev Container cho môi trường frontend (Node.js).
